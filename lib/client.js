...
const EloquaError = require('./errors').EloquaError
...
class Client extends EventEmitter {
  ...
  async getBaseUrl () {
    // getting inconsistent certificate results with this call
  ...
  async _request (opts) {
    ...
    if (!params.baseUrl) { // if a baseUrl is provided or we're calling the login url, skip this
      await this._init()
    }
